/////////////////////////////////////////////////////////////////////////////
//
//  Script : UnityEditorTitle.cs
//  Info   : 定制 UnityEditor 标题，暂时只支持 windows
//  Author : ls9512
...
{
    [InitializeOnLoad]
    class UnityEditorTitle
    {
        static UnityEditorTitle()
        {
    ...
    class UpdateUnityEditorAssetHandler
    {
    ...
    class UpdateUnityEditorProcess
    {
        ...
        private static string UTitle = "Aya Game Studio";
        ...
        public void SetTitle()
        {
            ...
            if (Time.realtimeSinceStartup > lasttime)
            {
                ...
                var strTitle = sbtitle.ToString();
                var ss = strTitle.Split('-');
        ...
        private bool IsMainWindow(IntPtr handle) { return (!(GetWindow(new HandleRef(this, handle), 4) != IntPtr.Zero) && IsWindowVisible(new HandleRef(this, handle))); }
