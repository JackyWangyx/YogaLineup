/////////////////////////////////////////////////////////////////////////////
//
//  Script : MemoryStorage.cs
//  Info   : 内存存储 避免了传统MemoryStream对于大块内存的连续占用
//  Author : CatLib
...
namespace Aya.Data
{
    public class MemoryStorage 
    {
        ...
        public void Write(byte[] buffer, int offset, int count, long index = 0)
        {
            ...
            Error.Check<ArgumentOutOfRangeException>(index >= 0);
        ...
        {
            Error.Check<Exception>(index < storage.Length);
