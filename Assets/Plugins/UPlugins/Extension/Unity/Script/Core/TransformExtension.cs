...
namespace Aya.Extension
{
    public static class TransformExtension
    {
        ...
        /// <param name="includeInactive">包括未激活物体</param>
        /// <returns>结果</returns>
        ...
        /// <param name="transform">变换</param>
        /// <param name="name">名字</param>
        /// <param name="includeInactive">包含未激活物体</param>
        /// <returns>结果</returns>
        ...
        /// <param name="updater">更新处理方法</param>
        /// <returns>transform</returns>
        ...
        /// </summary>
        /// <param name="transform">变换</param>
        /// <param name="scaleTo">缩放目标值</param>
        /// <returns>结果</returns>
        ...
        /// <param name="isWordSpace">是否使用世界坐标系</param>
        /// <returns>transform</returns>
        ...
        /// 获取物体的完整路径
        /// </summary>
        /// <param name="transform">当前节点</param>
        /// <returns>路径</returns>
