...
namespace Aya.TweenPro
{
    public static class GUIUtil
    {
        ...
        public static void ToggleOnOffButton(SerializedProperty property, string enableStr = "On", string disableStr = "Off")
        {
        ...
        public static void ToggleOnOffButton(SerializedProperty property, string propertyName, string enableStr, string disableStr)
        {
            using (GUIHorizontal.Create())
            {
                ...
                using (GUIColorArea.Create(EditorStyle.DisableColor, property.boolValue))
                {
        ...
        public static void ToggleButton(SerializedProperty property)
        {
            ToggleButton(property, property.displayName);
        }
        ...
        public static void DrawToolbarEnum(SerializedProperty property, string propertyName, Type enumType)
        {
            using (GUIHorizontal.Create())
            {
                ...
                for (var i = 0; i < buttons.Length; i++)
                {
                    ...
                    using (GUIColorArea.Create(Color.white, EditorStyle.DisableColor, property.intValue == index))
                    {
        ...
        #region Draw FromTo Property

        public static void DrawHoldProperty(SerializedProperty holdProperty)
        {
            using (GUIColorArea.Create(EditorStyle.EnableColor, holdProperty.boolValue))
            {
        ...
        {
            var disableColor = EditorStyle.ProgressDisableColor;
            var backColor = EditorStyle.ProgressBackColor;
            var rangeColor = EditorStyle.ProgressInRangeColor;
        ...
        public static void DrawDraggableProgressBar(UnityEngine.Object target, float height, float fromValue, float toValue, float currentValue, Action<float, float> onValueChanged = null)
        {
            var disableColor = EditorStyle.ProgressDisableColor;
            var backColor = EditorStyle.ProgressBackColor;
            var rangeColor = EditorStyle.ProgressValueColor;
            var inRangeColor = EditorStyle.ProgressInRangeColor;
            var outOfRangeColor = EditorStyle.ProgressOutOfRangeColor;
