...
namespace Aya.TweenPro
{
    ...
    public partial struct TweenShakeData
    {
        ...
        public void DrawShakeData()
        {
            ...
            var labelWidth = Tweener.EnableIndependentAxis ? EditorGUIUtility.labelWidth - EditorStyle.CharacterWidth : EditorGUIUtility.labelWidth;
            using (GUILabelWidthArea.Create(labelWidth))
            {
                using (GUIHorizontal.Create())
                {
                    if (Tweener.EnableIndependentAxis)
                    {
